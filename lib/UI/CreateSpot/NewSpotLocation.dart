...
class _NewSpotLocationState extends State<NewSpotLocation> {
   ...
   */
                  ...
                  Container(
                    ...
                    child: Text(
                      "Select the closest adress to safe the new spot",
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      MapEntry<Placemark, Location> country =
                          countries.entries.elementAt(index);
                      return ListTile(
                        onTap: () async {
                          setState(() {
                          ...
                          if (spot != null && review != null) {
                            ...
                            Navigator.of(context).push(
                              CupertinoPageRoute(
                                builder: (context) =>
                                    PostCheck(spot: spot, review: review!),
                              ),
                            );
                          } else {
                            UITemplates.showErrorMessage(
                                context, "Make sure everything is complete");
                          }
                        },
                        ...
                        subtitle: Text(country.key.locality! +
                            ", " +
                            country.key.country!),
                        tileColor: country.value != location
                            ? Colors.white12
                            : Colors.grey,
                      );
                    },
  ...
  Future<Spot?> saveSpot() async {
    ...
    Spot spot =
        Spot(widget.name, 0, 0, street.text, widget.description, widget.type);
