...
class _SignUpState extends State<SignUp> {
                  ...
                  onPressed: () async {
                    ...
                    if ((s == "")) {
                      Navigator.of(context).push(
                        CupertinoPageRoute(
                          builder: (context) =>
                              ContactShareView(isOutsideIntroFlow: false),
                        ),
                      );
                    } else {
  ...
  Future<String> signUpCorrect() async {
    ...
    try {
      User? user = await SignUpFunctions.signUp(numberControl.text,
          passwordControl.text, usernameControl.text, uusernameControl.text);
...
enum WaitingStates { UNIQUE, NOT_UNIQUE, LOADING }
