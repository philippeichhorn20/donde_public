      ...
      child: Stack(
        children: [
          FlutterMap(
            ...
            options: MapOptions(
              initialCenter: LatLng(Store.getListViewLocation()!.latitude,
                  Store.getListViewLocation()!.longitude),
              initialZoom: 6.0,
              maxZoom: 18.0,
            ...
            children: [
              ...
              MarkerLayer(markers: [
                Marker(
                  point: LatLng(Store.getListViewLocation()!.latitude,
                      Store.getListViewLocation()!.longitude),
                  child: Icon(
                    Icons.location_on,
          ...
          Positioned(
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  await widget.forceNewSpots(
                      ((40000 / pow(2, _mapController.camera.zoom)) * 2)
                          .toDouble(),
                      true);
                },
