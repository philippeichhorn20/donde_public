        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Container(
                margin:
                    EdgeInsets.only(bottom: 20, left: 15, right: 15, top: 80),
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).push(
                          CupertinoPageRoute(
                            builder: (context) =>
                                ContactView(ContactTypes.REQUESTS),
                          ),
                        );
                      },
                    ),
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).push(
                          CupertinoPageRoute(
                            builder: (context) =>
                                ContactView(ContactTypes.MY_REQUESTS),
                          ),
                        );
                      },
                    ),
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).push(
                          CupertinoPageRoute(
                            builder: (context) =>
                                ContactView(ContactTypes.FRIENDS),
                          ),
                        );
                      },
                    ),
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).push(
                          CupertinoPageRoute(
                            builder: (context) =>
                                ContactShareView(isOutsideIntroFlow: true),
                          ),
                        );
                      },
                    ),
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      child: Container(
                          ...
                          child: Text(
                            "Delete Account",
                            style: UITemplates.settingsTextred,
                          )),
                      onPressed: () async {
