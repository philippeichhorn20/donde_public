...
class UITemplates {
  ...
  static InputBorder inputBorder = OutlineInputBorder(
      borderSide: BorderSide(color: Colors.white38, style: BorderStyle.solid),
  ...
  static TextStyle numberOnReactionStyle =
  ...
  static TextStyle importantTextStyleHint = const TextStyle(
      color: Colors.white38, fontSize: 30, fontWeight: FontWeight.w500);
  static TextStyle importantTextStyle = const TextStyle(
  ...
  static TextStyle nameStyle =
      TextStyle(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 24);
  static TextStyle descriptionStyle = TextStyle(
      color: Colors.white54, fontWeight: FontWeight.w500, fontSize: 14);
  static TextStyle clickableText = TextStyle(
      color: Colors.white70, fontWeight: FontWeight.w500, fontSize: 16);
  static TextStyle clickableTextButBold = TextStyle(
      color: Colors.white70, fontWeight: FontWeight.w800, fontSize: 16);
  static TextStyle reviewNoteStyle = TextStyle(
  ...
  static TextStyle settingsTextdark = TextStyle(
    color: Colors.white54,
    fontWeight: FontWeight.w600,
    fontSize: 18,
  );
  static TextStyle settingsTextred = TextStyle(
    color: Colors.red,
    fontWeight: FontWeight.w600,
    fontSize: 18,
  );
  static TextStyle reviewExperienceStyle =
  ...
  static reviewText(double dark) {
    return TextStyle(
        color: dark < 0.5 ? Colors.black : Colors.white,
        ...
        return Row(
          ...
          children: [
            if (user.relationshipType != RelationshipTypes.ME &&
                user.relationshipType != RelationshipTypes.BLOCKED &&
                !minimal)
              TextButton.icon(
                  style: TextButton.styleFrom(
                  ...
                  onPressed: () async {
                    ...
                    setState(() {
                      ...
                      relTypeStr =
                          MyUser.relTypeToButtonString(user.relationshipType);
                    });
                  },
                  icon: Icon(
                    Icons.block,
            ...
            if (user.relationshipType == RelationshipTypes.REQUESTED_BY_OTHER)
              TextButton(
                onPressed: () async {
                  ...
                  setState(() {
                    user.relationshipType = user.relationshipType;
                    friendshipColor = user.relationshipType ==
                            RelationshipTypes.REQUESTED_BY_OTHER
                        ? Colors.green
                        : Colors.grey;
                    relTypeStr =
                        MyUser.relTypeToButtonString(user.relationshipType);
